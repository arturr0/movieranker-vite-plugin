            ...
            data.movies.forEach(movie => {
                ...
                if (movie.ratings) {
                    movie.ratings.forEach(rank => {
                        const rankMovie = new Movie(movie.id, movie.title, rank.rating, rank.userEmail, rank.post);
            ...
            data.people.forEach(person => {
                ...
                if (person.ratings) {
                    person.ratings.forEach(rank => {
                        const rankPerson = new Person(person.id, person.name, rank.rating, rank.userEmail, rank.post);
