...
eventSource.onmessage = async (event) => {
    ...
    clickedMovie.forEach(moviePost => {
        ...
        const userName = userData.user.id == Number(updateData.querySenderID) ? "Your post" : moviePost.rankerName;
        ...
        if (userData.user.id == Number(updateData.querySenderID)) postDiv.style.border = "2px solid green";
