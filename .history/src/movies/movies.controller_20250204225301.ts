...
export class MoviesController {
  ...
  async rateItem(
    ...
    @Res() res: Response // Add this here
  ) {
    ...
    try {
      ...
      if (type === 'movie') {
        ...
        ratingRecord = await this.prisma.ratingPerson.upsert({
          where: { userEmail_tmdbId: { userEmail, tmdbId: id } },  // Ensure unique constraint exists in Prisma schema
        ...
        console.log('Rating record:', ratingRecord);
