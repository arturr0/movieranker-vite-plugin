...
export class JwtAuthGuard implements CanActivate {
  ...
  canActivate(context: ExecutionContext): boolean {
    ...
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MjQwLCJlbWFpbCI6ImFhYWFhYWZmZmZmZkBnbWFpbC5jb20iLCJpYXQiOjE3MzgzNDg3ODYsImV4cCI6MTczODM1MjM4Nn0.OQYDSAftHe6UYgaAVueT22FvjkPsuGilAMU-iToPu3M"; // Extract token
    try {
