...
const SearchContent = () => {
  ...
  const [results, setResults] = useState({ title: null, actor: null }); // Store results separately
  ...
  const searchMovies = async () => {
    ...
    try {
      ...
      // Store results for both types separately
      setResults((prevResults) => ({
        ...prevResults,
        [type]: data, // Store results based on current type
      }));
    } catch (error) {
