...
const RateContainer = ({ message, movieID, movieTitle, moviePoster, movieAvg, movieVotes, lastQuery }) => {
        ...
        <div className="ratedContainer">
          ...
          <div className="myPost">
            ...
            <div className="postInput">
              ...
              <button className="sendPost" onClick={rateItem(type, movieID, movieTitle)}>SEND POST</button>
            </div>
          </div>
        </div>
      </div>
