...
const AuthForm = () => {
  // In the useEffect hook or similar initialization:
useEffect(() => {
  const link = document.createElement('link');
  link.rel = 'preload';
  link.href = '../styles/auth.css'; // Path to your specific CSS file
  link.as = 'style';
  document.head.appendChild(link);
  
  // Dynamically import the CSS after the preload link
