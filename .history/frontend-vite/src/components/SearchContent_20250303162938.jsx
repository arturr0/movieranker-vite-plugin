...
// Assuming Movie and Person classes are imported or defined
        ...
        data.movies.forEach((movie) => {
          if (movie.ratings) {
            movie.ratings.forEach((rank) => {
              newMoviesRanks.push(new Movie(movie.id, movie.title, rank.rating, rank.userEmail, rank.comment, rank.id));
            });
          }
        });
        ...
        data.people.forEach((person) => {
          if (person.ratings) {
            person.ratings.forEach((rank) => {
              newPeopleRanks.push(new Person(person.id, person.name, rank.rating, rank.userEmail, rank.comment, rank.id));
            });
          }
        });
